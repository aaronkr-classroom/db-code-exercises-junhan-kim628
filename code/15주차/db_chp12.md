...
CREATE SEQUENCE lab_num_seq
    START WITH 120      -- 첫 값 120
    INCREMENT BY 10     -- 10씩 증가
    MAXVALUE 990        -- 최댓값 990
    NOCYCLE             -- 최댓값 도달 후 처음부터 다시 X
    NOCACHE;            -- 값을 미리 만들어 두지 않음
...
DROP INDEX room_id_idx;   -- lab 테이블을 지우면 함께 삭제되므로 생략도 가능
DROP TABLE lab;           -- dept를 참조하므로 dept보다 먼저 삭제
DROP TABLE dept;
