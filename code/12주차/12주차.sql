...
-- CHECK 유저 레벨은 1~100만 가능함
ALTER TABLE users
ADD CONSTRAINT chk_user_level
CHECK (user_level >= 1 AND user_level <= 9999);
...
CHECK (grade in ('S', 'A', 'B', 'C', 'D', 'E', 'F', 'M'));
...
(7, 'RRRT', '12e2e2', 12, '2027-09-09', 'asd@asd22.com', 'offline');

-- 6: 
SELECT CONTRAINT_NAME, TABLE_NAME
